            ...
            <div class="container py-5">
                <div class="row h-100 align-items-center py-5">
                    <div class="col-lg-6">
                        ...
                        <p class="lead text-muted">Snippet by <a href="#"
                                class="text-muted">
                                <u>mahesh</u></a>
                        </p>
                    </div>
                    ...
                    <div class="col-md-6 mb-5">
                        <div class="bg-white rounded shadow-sm py-5 px-4"><img
                            ...
                            <h5 class="mb-0">Manuella Nevoresky</h5><span class="small text-uppercase text-muted">CEO -
                                Founder</span>
                            <ul class="social mb-0 d-flex list-inline mt-3">
                                <li class="list-inline-item"><a href="#" class="social-link"><i id="#social-link-i"
