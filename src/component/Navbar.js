    ...
    <div>
      ...
      <div className="header-bar ">
            ...
            <div className="social-media">
                <Link to="#" className="social-icon"><i className=""><FaFacebookF/></i></Link>
                <Link to="#" className="social-icon"><i className=""></i><FaTwitter/></Link>
                <Link to="#" className="social-icon"><i className=""><FaInstagram/></i>
                </Link>
            </div>
